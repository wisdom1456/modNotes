...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content">
    <div class="navbar bg-base-100 lg:hidden">
      <div class="flex-1">
        <a class="btn btn-ghost normal-case text-xl" href="/">notes.modible</a>
      </div>
      <div class="flex-none">
  ...
  <div class="drawer-side">
    ...
    >
      <li>
        ...
        >
          <a href="/" class="grow">modible.notes</a>
      ...
      <li>
        <a
          href="/journal/list"
          class={adminSection === "list" ? "active" : ""}
          on:click={closeDrawer}
        >
          <svg
            class="h-5 w-5"
      ...
      <li class="mt-auto">
        <a href="/journal/sign_out" class="mt-auto text-base">Sign Out</a>
      </li>
    </ul>
  </div>
</div>
